...
public class PlatformTests {
	...
	public static final List<Class<? extends PlatformTest>> tests = new ArrayList<>(
		Arrays.asList(RotateTest.class, MoveTest.class, ScaleTest.class, ColorTest.class, ZoomTest.class, ShakeTest.class));
