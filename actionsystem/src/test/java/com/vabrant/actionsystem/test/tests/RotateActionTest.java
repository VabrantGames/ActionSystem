    ...
    public void createTests() {
        addTest(new ActionTest("RotateBy") {
            ...
            public Action<?> run() {
                ...
                return RotateAction.rotateBy(
                                testObject, amountWidget.getValue(), durationWidget.getValue(), Interpolation.linear)
        ...
        addTest(new ActionTest("RotateTo") {
            ...
            public Action<?> run() {
                ...
                return RotateAction.rotateTo(
                                testObject,
                                rotationEndWidget.getValue(),
        ...
        addTest(new ActionTest("RotateByFromEnd (Custom)") {
            ...
            public Action<?> run() {
                ...
                GroupAction group = GroupAction.sequence(
                        RotateAction.rotateBy(testObject, 45, 0.5f, Interpolation.bounceOut)
