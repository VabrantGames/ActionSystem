    ...
    public void createTests() {
        addTest(new ActionTest("ScaleXBy") {
            ...
            public Action<?> run() {
                ...
                return ScaleAction.scaleXBy(
                                testObject, xAmountWidget.getValue(), durationWidget.getValue(), Interpolation.linear)
        ...
        addTest(new ActionTest("ScaleYBy") {
            ...
            public Action<?> run() {
                ...
                return ScaleAction.scaleYBy(
                                testObject, yAmountWidget.getValue(), durationWidget.getValue(), Interpolation.linear)
                        .subscribeToEvent(ActionEvent.END_EVENT, metricsListener)
                        .setName("ScaleYBy")
                        .reverseBackToStart(reverseBackToStartWidget.isChecked())
                        .setReverse(reverseWidget.isChecked());
        ...
        addTest(new ActionTest("ScaleXTo") {
            ...
            public Action<?> run() {
                ...
                return ScaleAction.scaleXTo(
                                testObject, xEndWidget.getValue(), durationWidget.getValue(), Interpolation.linear)
                        .subscribeToEvent(ActionEvent.END_EVENT, metricsListener)
                        .setName("ScaleXTo")
                        .reverseBackToStart(reverseBackToStartWidget.isChecked())
                        .setReverse(reverseWidget.isChecked());
        ...
        addTest(new ActionTest("ScaleYTo") {
            ...
            public Action<?> run() {
                ...
                return ScaleAction.scaleYTo(
                                testObject, yEndWidget.getValue(), durationWidget.getValue(), Interpolation.linear)
                        .subscribeToEvent(ActionEvent.END_EVENT, metricsListener)
                        .setName("ScaleYTo")
                        .reverseBackToStart(reverseBackToStartWidget.isChecked())
                        .setReverse(reverseWidget.isChecked());
