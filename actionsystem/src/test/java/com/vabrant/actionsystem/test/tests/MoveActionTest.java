    ...
    public void createTests() {
        addTest(new ActionTest("MoveXBy") {
            ...
            public Action<?> run() {
                ...
                MoveAction action = MoveAction.moveXBy(
                                testObject, xAmountWidget.getValue(), durationWidget.getValue(), Interpolation.exp5Out)
        ...
        addTest(new ActionTest("MoveYBy") {
            ...
            public Action<?> run() {
                ...
                MoveAction action = MoveAction.moveYBy(
                                testObject, yAmountWidget.getValue(), durationWidget.getValue(), Interpolation.exp5Out)
                        .subscribeToEvent(ActionEvent.END_EVENT, endListener)
                        .setName("MoveYBy")
                        .reverseBackToStart(reverseBackToStart)
                        .setReverse(reverse);
        ...
        addTest(new ActionTest("MoveBy") {
            ...
            public Action<?> run() {
                setupTest(
                        xStartWidget.getValue() + xAmountWidget.getValue(),
                        yStartWidget.getValue() + yAmountWidget.getValue());
                MoveAction action = MoveAction.moveBy(
                                testObject,
                                xAmountWidget.getValue(),
                                yAmountWidget.getValue(),
        ...
        addTest(new ActionTest("MoveByAngle") {
            ...
            public Action<?> run() {
                ...
                setupTest(endX, endY);
                MoveAction action = MoveAction.moveByAngleDeg(
                                testObject,
                                angle,
                                xAmountWidget.getValue(),
                                durationWidget.getValue(),
        ...
        addTest(new ActionTest("MoveByAngleRad") {
            ...
            public Action<?> run() {
                ...
                setupTest(endX, endY);
                MoveAction action = MoveAction.moveByAngleRad(
                                testObject,
                                angleWidget.getValue(),
                                xAmountWidget.getValue(),
                                durationWidget.getValue(),
                                Interpolation.exp5Out)
                        .subscribeToEvent(ActionEvent.END_EVENT, endListener)
        ...
        addTest(new ActionTest("MoveXTo") {
            ...
            public Action<?> run() {
                ...
                MoveAction action = MoveAction.moveXTo(
                                testObject, xEndWidget.getValue(), durationWidget.getValue(), Interpolation.exp5Out)
                        .subscribeToEvent(ActionEvent.END_EVENT, endListener)
                        .setName("MoveXto")
                        .reverseBackToStart(reverseBackToStart)
                        .setReverse(reverse);
        ...
        addTest(new ActionTest("MoveYTo") {
            ...
            public Action<?> run() {
                ...
                MoveAction action = MoveAction.moveYTo(
                                testObject, yEndWidget.getValue(), durationWidget.getValue(), Interpolation.exp5Out)
                        .subscribeToEvent(ActionEvent.END_EVENT, endListener)
                        .setName("MoveYTo")
                        .reverseBackToStart(reverseBackToStart)
                        .setReverse(reverse);
