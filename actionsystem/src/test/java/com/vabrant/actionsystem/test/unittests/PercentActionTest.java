...
public class PercentActionTest {
    ...
    public PercentTestAction getTestAction() {
        PercentTestAction action =
                PercentTestAction.set(testClass, end, duration).setLogLevel(ActionLogger.LogLevel.DEBUG);
    ...
    public void unmanagedMultiRunTest() {
        ...
        ActionManager manager = new ActionManager();
        PercentTestAction action =
                PercentTestAction.set(testClass, end, duration).unmanage().setLogLevel(ActionLogger.LogLevel.DEBUG);
    ...
    public void setTimeTest() {
        ...
        ActionManager manager = new ActionManager();
        PercentTestAction action = PercentTestAction.set(testClass, 10, 1).setLogLevel(ActionLogger.LogLevel.DEBUG);
