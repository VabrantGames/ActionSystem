...
//						.subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
				return BlankColorAction.changeAlpha(testObject, alphaEndWidget.getValue(), durationWidget.getValue(), Interpolation.linear)
						.subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
			}
		});
...
//		});
	...
	private static class BlankColorAction extends ColorAction<BlankColorAction> {
		...
		static BlankColorAction changeAlpha(Colorable colorable, float endAlpha, float duration, Interpolation interpolation) {
