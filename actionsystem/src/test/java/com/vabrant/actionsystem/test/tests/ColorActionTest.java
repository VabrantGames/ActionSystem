...
public class ColorActionTest extends ActionSystemTestListener {
    ...
    public void createTests() {
        ...
        addTest(new ActionTest("ChangeAlpha") {
            ...
            public Action<?> run() {
                // Set start color
                testObject.getColor().set(1, 0, 0, alphaStartWidget.getValue());
                ...
                // return ColorAction.changeAlpha(testObject, alphaEndWidget.getValue(), durationWidget.getValue(),
                // Interpolation.linear)
                // .subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
                return BlankColorAction.changeAlpha(
                                testObject, alphaEndWidget.getValue(), durationWidget.getValue(), Interpolation.linear)
                        .subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
            }
        });
        ...
        // public Action<?> run() {
        // //Set start color
        // testObject.getColor().set(redStartWidget.getValue(), greenStartWidget.getValue(),
        // blueStartWidget.getValue(), alphaStartWidget.getValue());
        //
        // //Set test end values
        // testAlphaEndWidget.setValue(alphaEndWidget.getValue());
        ...
        // testBrightnessEndWidget.setValue(-1);
        //
        // return ColorAction.changeColorRGBA(testObject, redEndWidget.getValue(), greenEndWidget.getValue(),
        // blueEndWidget.getValue(), alphaEndWidget.getValue(), durationWidget.getValue(), Interpolation.linear)
        // .subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
        // }
        // });
        //
        ...
        // testBrightnessEndWidget.setValue(-1);
        //
        // return ColorAction.changeRed(testObject, redEndWidget.getValue(), durationWidget.getValue(),
        // Interpolation.linear)
        // .subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
        // }
        // });
        ...
        // testBrightnessEndWidget.setValue(-1);
        //
        // return ColorAction.changeBlue(testObject, blueEndWidget.getValue(), durationWidget.getValue(),
        // Interpolation.linear)
        // .subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
        // }
        // });
        ...
        // testBrightnessEndWidget.setValue(-1);
        //
        // return ColorAction.changeGreen(testObject, greenEndWidget.getValue(), durationWidget.getValue(),
        // Interpolation.linear)
        // .subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
        // }
        // });
        ...
        // public Action<?> run() {
        // //Set start color
        // ColorAction.HSBToRGB(testObject.getColor(), hueStartWidget.getValue(), saturationStartWidget.getValue(),
        ...
        //
        // return ColorAction.changeColorHSBA(testObject, hueEndWidget.getValue(), saturationEndWidget.getValue(),
        // brightnessEndWidget.getValue(), alphaEndWidget.getValue(), durationWidget.getValue(), Interpolation.linear,
        // useHSBCheckbox.isChecked())
        // .subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
        // }
        // });
        //
        ...
        // testBlueEndWidget.setValue(-1);
        //
        // return ColorAction.changeHue(testObject, hueEndWidget.getValue(), durationWidget.getValue(),
        // Interpolation.linear, useHSBCheckbox.isChecked())
        // .subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
        // }
        // });
        //
        ...
        // testBlueEndWidget.setValue(-1);
        //
        // return ColorAction.changeSaturation(testObject, saturationEndWidget.getValue(), durationWidget.getValue(),
        // Interpolation.linear, useHSBCheckbox.isChecked())
        // .subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
        // }
        // });
        ...
        // testBlueEndWidget.setValue(-1);
        //
        // return ColorAction.changeBrightness(testObject, brightnessEndWidget.getValue(), durationWidget.getValue(),
        // Interpolation.linear, useHSBCheckbox.isChecked())
        // .subscribeToEvent(ActionEvent.END_EVENT, metricsListener);
        // }
        // });
    ...
    private static class BlankColorAction extends ColorAction<BlankColorAction> {

        static BlankColorAction obtain() {
            return obtain(BlankColorAction.class);
        }

        static BlankColorAction changeAlpha(
