...
public class ActionTest {
	...
	public void basicTest () {
		...
		MockAction action = MockAction.obtain().setName("Action").setLogLevel(ActionLogger.LOGGER_DEBUG);
	...
	public void unmanagedTest () {
		MockAction action = MockAction.obtain().setName("unmanaged").setLogLevel(ActionLogger.LOGGER_DEBUG).unmanage();
