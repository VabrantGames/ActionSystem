...
public class ScaleAction extends PercentAction<Scalable, ScaleAction> {
    ...
    public static ScaleAction scaleBy(
            Scalable scalable, float xAmount, float yAmount, float duration, Interpolation interpolation) {
    ...
    public static ScaleAction scaleTo(
            Scalable scalable, float xEnd, float yEnd, float duration, Interpolation interpolation) {
