...
public class MoveAction extends PercentAction<Movable, MoveAction> {
    ...
    public static MoveAction moveBy(
            Movable movable, float xAmount, float yAmount, float duration, Interpolation interpolation) {
        return obtain().moveBy(xAmount, yAmount).set(movable, duration, interpolation);
    }

    public static MoveAction moveByAngleRad(
            Movable movable, float radians, float amount, float duration, Interpolation interpolation) {
        return moveByAngleDeg(movable, MathUtils.radiansToDegrees * radians, amount, duration, interpolation);
    }

    public static MoveAction moveByAngleDeg(
            Movable movable, float degrees, float amount, float duration, Interpolation interpolation) {
    ...
    public static MoveAction moveTo(
            Movable movable, float xEnd, float yEnd, float duration, Interpolation interpolation) {
