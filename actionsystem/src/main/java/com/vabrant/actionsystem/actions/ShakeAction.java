...
public class ShakeAction extends PercentAction<Shakable, ShakeAction> {
	...
	public static <T extends ShakeLogicData> ShakeAction shakeX(Shakable shakable, ShakeLogic<T> logic, T data,  float amount, float duration, Interpolation interpolation) {
		return obtain()
				.shakeX(amount)
	...
	public static <T extends ShakeLogicData> ShakeAction shakeY(Shakable shakable, ShakeLogic<T> logic, T data, float amount, float duration,  Interpolation interpolation) {
		return obtain()
				.shakeY(amount)
				.set(shakable, duration, interpolation)
				.setLogic(logic)
	...
	public static <T extends ShakeLogicData> ShakeAction shakeAngle(Shakable shakable, ShakeLogic<T> logic, T data, float maxAngle, float duration, Interpolation interpolation) {
		return obtain()
				.shakeAngle(maxAngle)
				.set(shakable, duration, interpolation)
				.setLogic(logic)
	...
	public static <T extends ShakeLogicData> ShakeAction shake(Shakable shakable, ShakeLogic<T> logic, T data, float xAmount, float yAmount, float angleAmount, float duration, Interpolation interpolation) {
		return obtain()
	...
	public static CosSinShakeLogic COS_SIN_SHAKE_LOGIC = new CosSinShakeLogic(15 * MathUtils.PI,
			11 * MathUtils.PI, 6 * MathUtils.PI);
	...
	/**
	 * The angle value used in the shake. What this value means depends on the {@link ShakeLogic} used. It can be a
	 * maximum displacement or a multiplier.
	 * @return
	 */
