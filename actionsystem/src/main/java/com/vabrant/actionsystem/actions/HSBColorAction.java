...
public class HSBColorAction extends ColorAction<HSBColorAction> {
	...
	public static HSBColorAction changeColor (Colorable colorable, float hue, float saturation, float brightness, float duration,
		Interpolation interpolation) {
		return obtain().changeColor(hue, saturation, brightness).set(colorable, duration, interpolation);
	}

	public static HSBColorAction changeColor (Colorable colorable, float hue, float saturation, float brightness, float alpha,
	...
	public static HSBColorAction changeSaturation (Colorable colorable, float saturation, float duration,
		Interpolation interpolation) {
		return obtain().changeSaturation(saturation).set(colorable, duration, interpolation);
	}

	public static HSBColorAction changeBrightness (Colorable colorable, float brightness, float duration,
		Interpolation interpolation) {
